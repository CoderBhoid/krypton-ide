      ...
      <div className={`relative flex flex-col items-center transition-all duration-700 ${showContent ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        {GOOGLE_CLIENT_ID ? (
          <button
            ...
            disabled={isLoading}
            className="w-full max-w-[300px] flex items-center justify-center space-x-3 bg-white text-gray-800 py-3.5 rounded-2xl font-semibold text-base shadow-xl shadow-white/10 active:scale-[0.97] transition-all mb-4 disabled:opacity-60"
          >
            {isLoading ? (
        ...
        >
          {GOOGLE_CLIENT_ID ? 'Skip for now' : 'Get Started'}
        </button>

        {/* Version */}
        <p className="text-gray-700 text-[11px] mt-8">v1.0.0 • Sednium</p>
      </div>
    </div>
  );
}
    ...
    <div className="min-h-screen bg-[#0d1117] text-white flex flex-col">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative px-5 pt-12 pb-8">
          <div className="flex items-center justify-center space-x-3 mb-2">
            <img src="/icon.png" alt="Krypton" className="w-11 h-11 rounded-xl shadow-lg shadow-blue-500/25" />
      ...
      <div className="flex-1 px-5 pb-8">
        ...
        <button 
          ...
          className="w-full flex items-center justify-center space-x-2 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white py-3.5 rounded-xl font-semibold text-base shadow-lg shadow-blue-600/25 active:scale-[0.98] transition-all mb-6"
        >
          ...
          <div className="space-y-3">
            ...
            {sortedProjects.map((project, i) => {
              ...
              return (
                <div
                  key={project.id}
                  className="group bg-[#161b22] border border-[#21262d] rounded-xl p-4 active:bg-[#1c2333] transition-all cursor-pointer animate-fade-slide-up"
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
          ...
          <div className="relative w-full max-w-md bg-[#161b22] border-t sm:border border-[#21262d] rounded-t-2xl sm:rounded-2xl p-6 max-h-[85vh] overflow-y-auto animate-slide-up">
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white py-3.5 rounded-xl font-semibold text-base shadow-lg active:scale-[0.98] transition-all"
            >
              Create Project
            </button>
          </div>
